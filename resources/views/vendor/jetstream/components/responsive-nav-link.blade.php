...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-primary text-base font-medium text-primary bg-yellow-50 focus:outline-none focus:text-secondary-focus focus:bg-yellow-50 focus:border-secondary-focus transition'
