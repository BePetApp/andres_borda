<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-center text-2xl mb-4 font-bold">Pago</h1>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 rounded">
                <div class="p-4">
                    <article class="prose">
                        ...
                        <ul>
                            <li><b>Precio:</b> ${{ number_format($shopData['price']) }}</li>
                            <li><b>Cantidad a comprar:</b> {{ $shopData['amount'] }}</li>
                            <li class="mt-3"><b>Subtotal:</b> ${{ number_format($shopData['price'] * $shopData['amount']) }}</li>
                        </ul>
                    </article>
                </div>
