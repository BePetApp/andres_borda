...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="bumblebee">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100" x-data="{ showCart: false}">
            ...
            <div x-data="{ showPhoto: 0, gallery: {{$gallery}}, thumbnails: {{$thumbnails}} }" class="m-8 flex flex-col max-w-2xl items-center">
                <div>
                    <template x-for="(photo, index) in gallery" :key="index">
                        <div x-show="index === showPhoto" class=" w-11/12 h-80 mx-auto">
                            <img 
                                :src="photo" 
                                alt="photo"
